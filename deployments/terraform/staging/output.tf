...
output "subnets_ids" {
  value       = [for network in module.network.subnets : network.id]
...
output "subnets_private_access" {
  value       = [for network in module.network.subnets : network.private_ip_google_access]
...
output "subnets_secondary_ranges" {
  value       = [for network in module.network.subnets : network.secondary_ip_range]
  description = "The secondary ranges associated with these subnets"
}

output "route_names" {
  value       = [for route in module.network.routes : route.name]
